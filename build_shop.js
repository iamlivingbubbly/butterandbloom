...
function contact() {
  ...
  <section class="block" id="contact">
    ...
    <div class="contact-grid">
      <form class="contact-form" onsubmit="event.preventDefault();var f=this;document.getElementById('sent').hidden=false;document.getElementById('sent').innerHTML='Sending…';fetch('https://formsubmit.co/hello@butterbloom.ca',{method:'POST',body:new FormData(f),mode:'no-cors'}).then(function(){document.getElementById('sent').innerHTML='Thanks — your message is on its way to hello@butterbloom.ca. We reply within a day or two.';f.reset()}).catch(function(){document.getElementById('sent').innerHTML='Sorry — sending hit a hiccup. Please email hello@butterbloom.ca directly.'})">
        ...
        <p id="sent" class="sent" hidden>Messages go to hello@butterbloom.ca.</p>
      </form>
